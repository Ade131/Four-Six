...
struct FAQView: View {
    ...
    let faqData: [(String, String)] = [
        ...
        ("What temperature should my water be?", "It depends on the coffee! Lighter roasts can stand higher temperatures, up to 96 degrees, whereas darker roasts can be extracted as low as 80 degrees. Try different temparatures and see what tastes best."),
        ...
        ("What do the options do?", "Balance\nLets you fine-tune the water ratio in the initial stage of brewing. Opting for a sweeter taste reduces the volume of the first pour, whereas a brighter setting increases the volume.\n\nStrength\nAllows you to control the intensity by altering the number of pours in the second stage: 'Light' for a milder extraction in 2 pours, 'Strong' for a longer second stage with 4 pours.\n\nThese options are saved, so once you find the choices you prefer, you can set and forget!"),
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text("App icon and logo design by Jessika S (@jessika61)")
                    .font(.footnote)
                    .padding(.top, 15)
                
                Text("Special thanks to Sander, Dec, Conor, & Sam")
                    .font(.footnote)
                    .padding(.top, 15)
