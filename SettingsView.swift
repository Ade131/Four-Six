...
struct FAQView: View {
    ...
    let faqData: [(String, String)] = [
        ...
        ("What do the options do?", "The 'Balance' setting lets you fine-tune the water ratio in the initial stage of brewing. Opting for more water upfront enhances the brightness of the flavor, while reducing it yields a sweeter cup. On the other hand, the 'Strength' option allows you to control the intensity by altering the number of pours in the second stage: 'Light' for a subtler brew in just 2 pours, and 'Strong' for a bolder experience with 4 pours. 'Ratio' sets the ratio of coffee:water you want to brew, with lower ratio resulting in a more concentrated, but less extracted, cup. We recommend starting with the defaults, and adjusting the balance and strength from there. These options are saved, so once you find a cup you like, you can set and forget!"),
